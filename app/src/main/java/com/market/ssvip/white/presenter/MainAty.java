...
//    intent.putExtra(KEY_STATUS, 0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int statusBarHeight = WindowsController.getStatusBarHeight(viewpager.getContext());
        viewpager.setPadding(viewpager.getPaddingLeft(), statusBarHeight,
                viewpager.getPaddingRight(), viewpager.getPaddingBottom());
